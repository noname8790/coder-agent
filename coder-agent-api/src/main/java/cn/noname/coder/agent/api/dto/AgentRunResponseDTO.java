...
public record AgentRunResponseDTO(
        ...
        Integer rawContextTokens,
        Integer finalContextTokens,
        Double contextCompressionRatio,
        Integer memoryHitCount,
        Integer staleMemoryCount,
        Integer selectedFileSummaryCount,
        Integer selectedRawSnippetCount,
        String latestContextSnapshotPath,
        Long durationMs,
